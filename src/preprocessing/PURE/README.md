...
``
python make_dataset.py <path-to-downlaoded-PURE> <path-to-preprocessed-PURE> [--detector mediapipe]
``

2.) Then make the metadata file which contains paths to all of the preprocessed data:

``
python make_metadata.py <path-to-preprocessed-PURE> ../../../data/metadata/PURE.csv
``
